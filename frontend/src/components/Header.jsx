...
export default function Header({ activeHeaderTab, setActiveHeaderTab, searchQuery, setSearchQuery }) {
  ...
  return (
    <header className="header">
      ...
      <div className="header-right">
        ...
        <Wifi size={18} color="#0284c7" style={{ cursor: 'pointer' }} />
        <Video size={18} color="#64748b" style={{ cursor: 'pointer' }} />
        <img
